...
namespace WebApplication3.PatientDetails
{
    public partial class Delete : System.Web.UI.Page
    {
        ...
        // This is the Delete methd to delete the selected PatientDetail item
        ...
        public void DeleteItem(int ID)
        {
            using (_db)
            {
                ...
                if (item != null)
                {
                    _db.PatientDetails.Remove(item);
                    _db.SaveChanges();
                }
            }
        ...
        // This is the Select methd to selects a single PatientDetail item with the id
        ...
        public WebApplication3.Models.PatientDetail GetItem([FriendlyUrlSegmentsAttribute(0)]int? ID)
        {
            ...
            using (_db)
            {
	            return _db.PatientDetails.Where(m => m.ID == ID).FirstOrDefault();
            }
        }
