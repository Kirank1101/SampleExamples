<%@ Page Title="PatientDetailDelete" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Delete.aspx.cs" Inherits="WebApplication3.PatientDetails.Delete" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <h3>Are you sure want to delete this PatientDetail?</h3>
        <asp:FormView runat="server"
            ...
            <ItemTemplate>
                <fieldset class="form-horizontal">
                    <legend>Delete PatientDetail</legend>
							<div class="row">
