<%@ Page Title="PatientinfoList" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Default.aspx.cs" Inherits="WebApplication3.Models.Patientinfoes.Default" %>
        ...
        <asp:ListView id="ListView1" runat="server"
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>
								<asp:LinkButton Text="BloodGroup" CommandName="Sort" CommandArgument="CategoryId" runat="Server" />
							</th>
                            <th>&nbsp;</th>
                        </tr>
                    </thead>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Models/Patientinfoes/Details", Item.ID) %>' Text="Details" /> | 
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Models/Patientinfoes/Edit", Item.ID) %>' Text="Edit" /> | 
                        <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/Models/Patientinfoes/Delete", Item.ID) %>' Text="Delete" />
                    </td>
                </tr>
            </ItemTemplate>
        </asp:ListView>
