<%@ Page Title="BloodGroupDelete" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Delete.aspx.cs" Inherits="WebApplication3.Models.BloodGroups.Delete" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <h3>Are you sure want to delete this BloodGroup?</h3>
        <asp:FormView runat="server"
            ...
            <ItemTemplate>
                <fieldset class="form-horizontal">
                    <legend>Delete BloodGroup</legend>
							<div class="row">
